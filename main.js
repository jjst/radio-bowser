			...
			_List_fromArray(
				[
					...
					$MartinSStewart$elm_audio$Audio$encodeBufferId(
						$MartinSStewart$elm_audio$Audio$audioSourceBufferId(audio_.S))),
					_Utils_Tuple2(
					'startTime',
					...
					_Utils_Tuple2(
					'loop',
					$MartinSStewart$elm_audio$Audio$encodeLoopConfig(audio_.M)),
					_Utils_Tuple2(
					'playbackRate',
...
var $MartinSStewart$elm_audio$Audio$updateAudioState = F2(
	function (_v0, _v1) {
		...
		var validAudio = A2(
			...
			function (_v7) {
				var a = _v7.b;
				return _Utils_eq(a.S, audioGroup.S) && (_Utils_eq(
					$MartinSStewart$elm_audio$Audio$audioStartTime(a),
					$MartinSStewart$elm_audio$Audio$audioStartTime(audioGroup)) && _Utils_eq(a.C, audioGroup.C));
			},
		...
		var newPendingRequests = A2(
			...
			F2(
				function (index, request) {
					return _Utils_Tuple2(model.Q + index, request);
				}),
			flattenedAudioCmd);
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					...
					Q: model.Q + $elm$core$List$length(flattenedAudioCmd)
				}),
			A2(
				$elm$json$Json$Encode$list,
				$elm$core$Basics$identity,
...
var $MartinSStewart$elm_audio$Audio$initHelper = F3(
	function (audioPort, audioFunc, _v0) {
		...
		var json = _v1.c;
		var initialModel = {Z: audioState, ag: newNodeGroupIdCounter, e: $elm$core$Dict$empty, Q: 0, R: $elm$core$Maybe$Nothing, o: $elm$core$Dict$empty, F: model};
...
var $MartinSStewart$elm_audio$Audio$updateHelper = F4(
	function (audioPort, audioFunc, userUpdate, _v0) {
		...
		var _v1 = A2(userUpdate, audioData_, model.F);
		...
		var newModel = _Utils_update(
			model,
			{Z: audioState, ag: newNodeGroupIdCounter, F: newUserModel});
	...
	function (app, msg, _v0) {
		...
		if (msg.$ === 1) {
			...
			switch (response.$) {
				case 0:
					...
					if (!_v3.$) {
						...
						var maybeUserMsg = A2(
							...
							$mgold$elm_nonempty_list$List$Nonempty$toList(pendingRequest.G));
						if (!maybeUserMsg.$) {
				...
				case 2:
					var samplesPerSecond = response.a.R;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								R: $elm$core$Maybe$Just(samplesPerSecond)
							}),
				...
				if (!result.$) {
					...
					return _Utils_Tuple3(
						_Utils_update(
							model,
							{
								t: $author$project$Main$Success(stations)
							}),
						command,
						$MartinSStewart$elm_audio$Audio$cmdNone);
				} else {
...
var $rundis$elm_bootstrap$Bootstrap$Internal$ListGroup$defaultOptions = {aW: false, aX: false, a4: _List_Nil, bh: false, b0: $elm$core$Maybe$Nothing};
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2('active', options.aX),
						_Utils_Tuple2('list-group-item-action', options.aW)
					]))
			]),
		_Utils_ap(
			_List_fromArray(
		...
		switch (_v0) {
			...
			case 2:
				return _Utils_update(
					options,
					{
						by: $elm$core$Maybe$Just(offset_)
					});
			case 3:
				return _Utils_update(
					options,
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultColOptions = {aZ: $elm$core$Maybe$Nothing, a_: $elm$core$Maybe$Nothing, a$: $elm$core$Maybe$Nothing, a0: $elm$core$Maybe$Nothing, a1: $elm$core$Maybe$Nothing, a4: _List_Nil, bx: $elm$core$Maybe$Nothing, by: $elm$core$Maybe$Nothing, bz: $elm$core$Maybe$Nothing, bB: $elm$core$Maybe$Nothing, bC: $elm$core$Maybe$Nothing, bK: $elm$core$Maybe$Nothing, bL: $elm$core$Maybe$Nothing, bM: $elm$core$Maybe$Nothing, bN: $elm$core$Maybe$Nothing, bO: $elm$core$Maybe$Nothing, bQ: $elm$core$Maybe$Nothing, bR: $elm$core$Maybe$Nothing, bS: $elm$core$Maybe$Nothing, bT: $elm$core$Maybe$Nothing, bU: $elm$core$Maybe$Nothing, bV: $elm$core$Maybe$Nothing, bW: $elm$core$Maybe$Nothing, bX: $elm$core$Maybe$Nothing, bY: $elm$core$Maybe$Nothing, bZ: $elm$core$Maybe$Nothing, b6: $elm$core$Maybe$Nothing, aQ: $elm$core$Maybe$Nothing, aR: $elm$core$Maybe$Nothing, aS: $elm$core$Maybe$Nothing, aT: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing};
	...
	return _Utils_ap(
		...
		_Utils_ap(
			$rundis$elm_bootstrap$Bootstrap$Grid$Internal$offsetsToAttributes(
				_List_fromArray(
					[options.bC, options.bz, options.by, options.bx, options.bB])),
			_Utils_ap(
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultRowOptions = {a4: _List_Nil, bk: $elm$core$Maybe$Nothing, bl: $elm$core$Maybe$Nothing, bm: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bo: $elm$core$Maybe$Nothing, cb: $elm$core$Maybe$Nothing, cc: $elm$core$Maybe$Nothing, cd: $elm$core$Maybe$Nothing, ce: $elm$core$Maybe$Nothing, cf: $elm$core$Maybe$Nothing};
